 ...
 */
export const updateSvgSpecialColors = () => {
    if (typeof window === 'undefined')
        return;
    ...
    allSvgs.forEach((svg) => {
        ...
        const yellowElements = svg.querySelectorAll('[fill="#FFFF00"], [fill="#ffff00"], [fill="yellow"], [stroke="#FFFF00"], [stroke="#ffff00"], [stroke="yellow"]');
        const redElements = svg.querySelectorAll('[fill="#FF0000"], [fill="#ff0000"], [fill="red"], [stroke="#FF0000"], [stroke="#ff0000"], [stroke="red"]');
 ...
 */
export const initSvgColorAdjustments = () => {
